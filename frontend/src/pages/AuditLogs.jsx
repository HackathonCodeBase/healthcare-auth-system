        ...
        <div className="space-y-6">
            <div className="flex flex-col sm:flex-row justify-between items-center gap-4 bg-dark-card border border-dark-border p-5 rounded-2xl shadow-lg">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <h2 className="text-xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-blue-400 to-blue-600">Global Audit Trails</h2>
                ...
                <div className="flex gap-2">
                    <div className="relative w-64">
                        ...
                        <input
                            ...
                            className="w-full bg-dark-bg border border-dark-border pl-9 pr-4 py-2 rounded-xl text-sm focus:outline-none focus:ring-1 focus:border-blue-400 focus:ring-blue-400/50"
                        />
                    </div>
                            ...
                            {filteredLogs.map(log => (
                                <tr key={log.id} className="hover:bg-dark-bg/50 transition-colors">
                                    ...
                                    <td className="px-6 py-3">
                                        ...
                                        <p className="text-[10px] text-blue-400 uppercase tracking-wide">{log.user?.role}</p>
                                    </td>
                                    <td className="px-6 py-3">
